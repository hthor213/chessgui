 ...
 *  rake_deck → an Avoidance puzzle deck session (spec 211 solver, Tier 1).
...
const CHAPTER_1: Chapter = {
  ...
  week: [
    ...
    block("c1-mon", 1, "rake_deck", "Rake deck + rapid game", "An Avoidance deck (don't step on the rake), then one rapid game (15+10) with a full review.", 45),
    ...
    block("c1-thu", 4, "rake_deck", "Rake deck + rapid game", "An Avoidance deck (don't step on the rake), then one rapid game (15+10) with a full review.", 45),
