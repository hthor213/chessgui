...
- [x] Engine settings expose contempt and free-form custom UCI options. (000:45) (code-verified 2026-07-16)

## Later / uncaptured requirements (audit 2026-07-16)

- [x] Analysis supports `go depth N` / `movetime` alongside infinite. (000:41) (code-verified 2026-07-16)
- [x] User can play Black (color picker; board flips). (000:79) (code-verified 2026-07-16)
- [x] Local play-vs-engine clocks: untimed/increment/classical/rapid/blitz/custom. (000:81; 900:6) — (code-verified 2026-07-16, supersedes same-day PARTIAL): presets shipped (Untimed, Blitz 3+2/5+3, Rapid 10+5/15+10, Classical 30+20) in lib/play-clock.ts + use-play-clock.ts with flag adjudication; custom entry now shipped — "Custom" chip in play-setup-dialog.tsx with validated Minutes (1–180) + Increment (0–120s) inputs, last-used values persisted under `play-custom-tc`, feeding `customClockPreset` into the same clock/flag/engine-go path as presets
- [x] One-click seamless handoff from finished engine game to analysis mode. (000:83; 900's pointer to 212 is tournament-scoped, doesn't cover this) (code-verified 2026-07-16: page.tsx handleAnalyzeGame)
