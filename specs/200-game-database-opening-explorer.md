...
- [x] Dedicated live opening-explorer panel on the analyze board — separate from the
      Database tab's position-search panel above (000:60-61, 200:93 "a later slice") (code-verified 2026-07-16: opening-explorer-panel.tsx + test)

### Later / uncaptured requirements (audit 2026-07-16)

- [x] Extend search beyond player/ECO/date to event, result, Elo range, full-text (000:60-61) (code-verified 2026-07-16: GameFilter max_elo/text/tag added; event/result/min_elo pre-existing)
